...
export class CreateUserRequest extends jspb.Message { 
    getUserId(): number;
    setUserId(value: number): CreateUserRequest;

    hasBody(): boolean;
    clearBody(): void;
    getBody(): User | undefined;
    setBody(value?: User): CreateUserRequest;
...
export class FindUserByEmailRequest extends jspb.Message { 
    getEmail(): string;
    setEmail(value: string): FindUserByEmailRequest;
...
export class UpdateUserByIDRequest extends jspb.Message { 
    getUserId(): number;
    setUserId(value: number): UpdateUserByIDRequest;

    hasBody(): boolean;
    clearBody(): void;
    getBody(): User | undefined;
    setBody(value?: User): UpdateUserByIDRequest;
